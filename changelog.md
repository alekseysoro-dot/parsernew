...
- `доработка` | замена Apify на свой WB-парсер | wb_client.py (search.wb.ru v18), обновлены parse.py, scheduler.py, 3 файла тестов | 55/55 тестов passed, ожидается коммит и деплой
...
- `деплой` | шаг 4: проверка работоспособности | curl health + браузер https://mvp1.ru | ожидается результат
