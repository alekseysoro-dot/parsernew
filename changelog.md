...
- `доработка` | добавлены категории "Здоровье" и "Техника" в фильтры и модалку ключевых слов | 2 места: чипы сайдбара + select модалки | закоммичено (22b9c8d), ожидается деплой
